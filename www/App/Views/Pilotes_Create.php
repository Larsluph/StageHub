...
<head>
  ...
  <meta name="description" content="Create tutor">
    <title>StageHub - Create Tutor</title>
                            ...
                            <form method="POST">
                                <div class="row mt-2">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input id="nom_user" name="nom_user" type="text" class="form-control" placeholder="Enter the surname of the tutor" required>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label class="labels" for="prenom_user">First name :</label>
                                        <input id="prenom_user" name="prenom_user" type="text" class="form-control" placeholder="Enter the first name of the tutor" required>
                                    </div>
                                    <div class="col-md-12 mb-3">
